...
public class DeplacementJoueur : MonoBehaviour
{
    ...
    public float positionZoneY = 4f;
    public float positionZoneMinX = -4f;
    public float positionZoneMaxX = 5f;
    ...
    public void ReplacerZone()
    {
        ...
        zoneArrivee.transform.position = new Vector2(Random.Range(positionZoneMinX, positionZoneMaxX), positionZoneY);
    }
